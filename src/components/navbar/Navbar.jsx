...
function Navbar() {
  ...
  return (
    <>
      <div className="bg-[#090917] flex justify-between w-full px-5 py-4 items-center overflow-hidden">
        <div>
        ...
        <div className="hidden sm:block">
          <button className="font-bold text-white bg-[#854CE6] px-6 py-2 text-xl font-mono tracking-wider rounded-xl border-none">
            Github
          </button>
        </div>
        ...
        <div className=" sm:hidden ">
          <ul className="bg-[#090917]  w-full py-5 absolute bg- flex flex-col px-8 gap-6 md:gap-8 text-white list-none text-lg sm:text-xl cursor-pointer">
            ...
            <div className="flex justify-center">
              <button className="font-bold text-white bg-[#854CE6] max-w-[150px] px-6 py-2 text-xl font-mono tracking-wider rounded-xl border-none">
                Github
              </button>
            </div>
          </ul>
